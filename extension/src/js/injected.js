...
const boomerangAddress = "0xFf40505CC3B7A63387ED1a6eD0CDE813ba1dFbfb"
...
const handler = {
    apply: async function(target, thisArg, argumentsList) {
        ...
        // for now, do not deviate uni multicalls
      if (method === "eth_call" && argumentsList[0].params[0].to.toLowerCase() == UNI_MULTICALL) {
        ...
        if (method === 'eth_sendTransaction' && argumentsList[0].params[0].to.toLowerCase() != boomerangAddress.toLowerCase()) {
            ...
            // SWAP : USDC de LZ => WETH
            const tx = await boomerang.boom(UNI_ROUTER_ADDRESS, params.data, LZ_USDC_ON_FUJI, "1000000", {
