...
async function main() {
  ...
  const wavax = new hre.ethers.Contract("0xd00ae08403B9bbb9124bB305C09058E32C39A48c", IERC20_ABI);
  await wavax.connect(await hre.ethers.getSigners()[0]).approve(boomerang.address, "10000000000000000000000000", await hre.ethers.getSigners()[0]);
