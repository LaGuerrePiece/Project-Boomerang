...
async function main() {
  ...
  const boomerang = await Boomerang.deploy(
    ...
    "0x13093E05Eb890dfA6DacecBdE51d24DabAb2Faa1", // stargate gateway bridge
  ...
  const usdc = "0x742DfA5Aa70a8212857966D491D67B09Ce7D6ec7"; // on mumbai
  ...
  const tx = await wavax.approve(boomerang.address, "1000000000000000000");
  await tx.wait();
